...
class VQAFeatureDataset(Dataset):
    def __init__(self, name, args, dictionary, dataroot='data', question_len=12):
        ...
        self.label_token_dict = json.load(open(dataroot + '/label2ans_dict.json'))
    ...
    def __getitem__(self, index):
        ...
        if None!=answer:
            ...
            return image_data, question, target, answer_type
        else:
            return image_data, question, answer_type
